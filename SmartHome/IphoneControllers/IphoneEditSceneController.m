...
-(void)setupSubTypeView
{
    ...
    for(NSString *type in self.typeArr)
    {
        ...
        {
            [self.subTypeView addItemWithTitle:@"照明" imageName:@""];
        }else if([type isEqualToString:@"环境"]){
            [self.subTypeView addItemWithTitle:@"环境" imageName:@""];
        }else if([type isEqualToString:@"影音"])
        {
            [self.subTypeView addItemWithTitle:@"影音" imageName:@""];
        }else if ([type isEqualToString:@"安防"])
            {
                [self.subTypeView addItemWithTitle:@"安防" imageName:@""];
            }else{
                [self.subTypeView addItemWithTitle:@"其他" imageName:@""];
            }
...
-(void)setupDeviceTypeView
{
    ...
    for(NSString *deviceType in self.devicesTypes)
    {
        ...
        {
            [self.deviceTypeView addItemWithTitle:@"灯光" imageName:@""];
        }else if([deviceType isEqualToString:@"窗帘"]){
            [self.deviceTypeView addItemWithTitle:@"窗帘" imageName:@""];
        }else if([deviceType isEqualToString:@"空调"])
        {
            [self.deviceTypeView addItemWithTitle:@"空调" imageName:@""];
        }else if ([deviceType isEqualToString:@"FM"])
        {
            [self.deviceTypeView addItemWithTitle:@"FM" imageName:@""];
        }else if([deviceType isEqualToString:@"网络电视"]){
            [self.deviceTypeView addItemWithTitle:@"网络电视" imageName:@""];
        }else if([deviceType isEqualToString:@"智能门锁"]){
             [self.deviceTypeView addItemWithTitle:@"智能门锁" imageName:@""];
        }else if([deviceType isEqualToString:@"DVD"]){
             [self.deviceTypeView addItemWithTitle:@"DVD电视" imageName:@""];
        }else{
             [self.deviceTypeView addItemWithTitle:@"其他" imageName:@""];
        }
