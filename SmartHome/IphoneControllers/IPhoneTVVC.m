...
@interface IPhoneTVVC ()<UITableViewDataSource,UITableViewDelegate>
...
-(NSMutableArray *)projectIds
{
    if(!_projectIds)
    {
        ...
        {
            [_projectIds addObjectsFromArray:[SQLManager getDeviceByTypeName:@"网络电视" andRoomID:self.roomID]];
        }else{
