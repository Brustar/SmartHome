...
@interface IphoneSceneAirVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation IphoneSceneAirVC
...
-(NSMutableArray *)projectIds
{
    if(!_projectIds)
    {
        ...
        {
            [_projectIds addObjectsFromArray:[SQLManager getDeviceByTypeName:@"空调" andRoomID:self.roomID]];
        }else{
