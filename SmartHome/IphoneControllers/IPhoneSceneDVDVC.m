...
@interface IPhoneSceneDVDVC ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation IPhoneSceneDVDVC
...
-(NSMutableArray *)projectIds
{
    if(!_projectIds)
    {
        ...
        {
            [_projectIds addObjectsFromArray:[SQLManager getDeviceByTypeName:@"DVD" andRoomID:self.roomID]];
        }else{
